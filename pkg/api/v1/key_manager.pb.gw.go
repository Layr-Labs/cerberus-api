...
func request_KeyManager_GetPublicKeys_0(ctx context.Context, marshaler runtime.Marshaler, client KeyManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetPublicKeysRequest
	var metadata runtime.ServerMetadata
...
func local_request_KeyManager_GetPublicKeys_0(ctx context.Context, marshaler runtime.Marshaler, server KeyManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetPublicKeysRequest
	var metadata runtime.ServerMetadata
...
func RegisterKeyManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KeyManagerServer) error {
	...
	mux.Handle("POST", pattern_KeyManager_GetPublicKeys_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/keymanager.v1.KeyManager/GetPublicKeys", runtime.WithHTTPPathPattern("/keymanager.v1.KeyManager/GetPublicKeys"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_KeyManager_GetPublicKeys_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_KeyManager_GetPublicKeys_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterKeyManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KeyManagerClient) error {
	...
	mux.Handle("POST", pattern_KeyManager_GetPublicKeys_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/keymanager.v1.KeyManager/GetPublicKeys", runtime.WithHTTPPathPattern("/keymanager.v1.KeyManager/GetPublicKeys"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_KeyManager_GetPublicKeys_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_KeyManager_GetPublicKeys_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"keymanager.v1.KeyManager", "GetPublicKeys"}, ""))
)
...
var (
	...
	forward_KeyManager_GetPublicKeys_0 = runtime.ForwardResponseMessage
)
